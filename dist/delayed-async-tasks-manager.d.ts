 ...
 */
export declare class DelayedAsyncTasksManager<UncaughtErrorType = Error> {
    private readonly _keyToExecutionInfo;
    private _uncaughtErrors;
    private _pendingTasksCount;
    private _currentlyExecutingTasksCount;
    /**
     * pendingTasksCount
     *
     *
     ...
     */
    get currentlyExecutingTasksCount(): number;
    /**
     * uncaughtErrorsCount
     *
     ...
     */
    get uncaughtErrorsCount(): number;
    /**
     * isPending
     *
     ...
     *          otherwise, `false`.
     */
    isPending(uniqueKey: TaskUniqueKey): boolean;
    /**
     * isExecuting
     *
     ...
     *          otherwise, `false`.
     */
    isExecuting(uniqueKey: TaskUniqueKey): boolean;
    /**
     * isManaged
     *
     ...
     */
    isManaged(uniqueKey: TaskUniqueKey): boolean;
    /**
     * addTask
     *
     ...
     */
    addTask(uniqueKey: TaskUniqueKey, task: DelayedTask, delayMs: number): void;
    /**
     * tryAbortPendingTask
     *
     ...
     */
    tryAbortPendingTask(uniqueKey: TaskUniqueKey): boolean;
    /**
     * awaitTaskCompletion
     *
     ...
     */
    awaitTaskCompletion(uniqueKey: TaskUniqueKey): Promise<boolean>;
    /**
     ...
     */
    awaitCompletionOfAllCurrentlyExecutingTasks(): Promise<void>;
    /**
